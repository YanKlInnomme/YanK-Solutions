const Prestations = [
    {
      index: "0",
      backgroundimage: "background: url(../images/prestations/atelier-background.avif);",
      image: "atelier.avif",
      title: "Atelier",
      subtitle: "JdR à l'école",
      details: "Prêt·e pour une expérience éducative unique&nbsp;? Offrez à vos élèves un atelier de découverte du Jeu de Rôles. Ces ateliers peuvent encourager la créativité, la collaboration, la résolution de problèmes et l'expression individuelle. Transformez l'apprentissage en aventure&nbsp;!",
      boxea: {
        one: {
      ...
      row01:
        `<label><i class="fa-solid fa-school"></i>&ensp;Établissement</label>
          <br>
        <input type='text' name='school' id='school0' required>`,
      row02:
        `<label><i class="fa-solid fa-graduation-cap"></i>&ensp;Niveau de classe</label>
          <br>
        <input type='text' name='classroom-level' id='classroom-level0' required>`,
      row03:
      ...
      row06: `<input type='hidden' name='gps-coordinates' id='gps-coordinates0' required></input>`,
      row07:
      ...
      row11: `<input type="hidden" name="overall-estimate" id="overall-estimate0" value="">`,
      row12:
  ...
  Prestations.forEach((prestation) => {
    ...
    card.innerHTML = `
      ...
      <div class="additional-form" id="additional-form${prestation.index}">
        <form action="process-form__services-for-local-authorities.php" method="post">
          <div class="group">
  ...
  function calcEstimate0() {
    ...
    var schoolField = document.getElementById("school0");
    var classroomField = document.getElementById("classroom-level0");
    ...
    schoolField.classList.remove("highlight-empty");
    classroomField.classList.remove("highlight-empty");
    ...
    if (schoolField.value === "") {
      schoolField.classList.add("highlight-empty");
      isFormValid = false;
    }
    if (classroomField.value === "") {
      classroomField.classList.add("highlight-empty");
      isFormValid = false;
    }
        ...
        if (data.length > 0) {
          ...
          fetch(osrmApiUrl)
            ...
            .then(data => {
              ...
              let basePrice = 280; // à partir de 280€
